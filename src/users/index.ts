...
const _caller = async (account: string, target: string = '', chain: Chain = 'bsc'): Promise<ITransaction[]> => {
...
export const getAccountTransfers = async (account: string, chain: Chain = 'bsc'): Promise<ITransaction[]> => {
